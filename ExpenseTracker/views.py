...
class ExpenseListView(FormView):
    template_name = 'ExpenseTracker/ExpenseTracker.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        for account in accounts:
            expense = accounts.expense_list.all()
        ...
        aggregated_data = [{ 'year_month': key, 'expenses': sum(item['amount']
        for item in value)} for key, value in expense_data_graph.items()]
